...
这是一个让“开发应用”变得像聊天一样简单的平台。无需配置环境，只需向 Agent 提出需求，即可快速生成专属的桌面、Web 或移动端 App。

而这一切的终极形态，是我们内置的**可自我进化的 AI Assistant**。它打破了人机交互的传统边界：不仅能陪你聊天、为你答疑解惑，更拥有**实时重写自身代码**的特殊能力。随着你日常的使用与交互，它可以随时动态重塑自己的界面、扩展全新的功能。它不仅仅是一个工具，更是一个会随着你的需求无限生长的智能生命。

[下载桌面端体验](https://github.com/DawnChat/DawnChat/releases) · [AI Assistant 路线图](./docs/public/architecture/assistant/ai-gui-workspace-v1-roadmap.md) · [查看宿主-插件会话协议](./docs/public/architecture/assistant/host-plugin-session-protocol.md) · [从源码开始](#从源码开始)
...
1. **对话即开发**：支持生成桌面、Web 与移动端 App。抹平环境配置的阻力，让创造的门槛降到最低。
2. **Agent As Builder**：Agent 不再是浮在表面的聊天框，它能理解界面上下文，**直接修改底层代码**，让你立刻看到 UI 的实时重构。
3. **自我进化的智能体**：彻底打破“开发 -> 编译 -> 发布”的死循环。应用在运行中可以被持续迭代，甚至根据交互**实时重写自身**，无限生长。
...
### 1. 见证 AI Assistant 的“自我进化”

官方 AI Assistant 绝非一个附带的 Demo，而是 DawnChat 愿景的最强体现。
它不只回答问题，更能根据你的需求，**当场重写自己的底层代码**，实时长出新的界面与能力。我们正在把它打造成未来 AI GUI 工作空间的样板。

<!-- TODO: 替换为实际的 webp 演示动图链接 -->
> <img src="https://via.placeholder.com/800x450.webp?text=AI+Assistant+%E8%87%AA%E6%88%91%E8%BF%9B%E5%8C%96%E6%BC%94%E7%A4%BA" alt="AI Assistant 自我进化演示" width="100%" />

### 2. 在工作台里“边聊边造”

DawnChat 内置了一个强大的开发工作台。
你可以圈选界面上的任何元素，将上下文抛给 Agent，只需一句“把这个按钮改成红色并加个动画”，就能看着右侧预览区实时生效。

<!-- TODO: 替换为实际的 webp 演示动图链接 -->
> <img src="https://via.placeholder.com/800x450.webp?text=%E5%9C%A8%E5%B7%A5%E4%BD%9C%E5%8F%B0%E9%87%8C%E8%BE%B9%E8%81%8A%E8%BE%B9%E9%80%A0%E6%BC%94%E7%A4%BA" alt="边聊边造演示" width="100%" />
...
<!-- TODO: 替换为实际的 webp 演示动图链接 -->
> <img src="https://via.placeholder.com/800x450.webp?text=%E4%B8%80%E6%AC%A1%E5%AF%B9%E8%AF%9D%EF%BC%8C%E8%B7%A8%E7%AB%AF%E7%94%9F%E6%88%90%E6%BC%94%E7%A4%BA" alt="跨端生成演示" width="100%" />
...
- 作为官方参考 App 开放
- 用于验证 AI 原生交互形态
- 用于探索宿主管理会话、workspace、page capability 与自我进化 runtime
...
- 宿主-插件会话协议：[`docs/public/architecture/assistant/host-plugin-session-protocol.md`](./docs/public/architecture/assistant/host-plugin-session-protocol.md)
